...
$compag = (int)(!isset($_GET['pag'])) ? 1 : $_GET['pag'];
	$TotalReg = $conexion->query("SELECT * FROM eventos WHERE iduser='$_SESSION[iduser]'");
    ...
    $consultavistas ="SELECT
                        ...
                        eventos.direccion
						FROM
						eventos WHERE iduser='$_SESSION[iduser]'
						ORDER BY
						eventos.idevento ASC
						LIMIT ".(($compag-1)*$CantidadMostrar)." , ".$CantidadMostrar;
                       // echo $consultavistas;
    $consulta=$conexion->query($consultavistas);
    echo'<section class="postes">';
    while ($lista=$consulta->fetch_row()) {
        echo '<div class="card">
        <img src="ImageSources/0d50763575b69b3cbccb7bd3325fd706.jpg" alt="Imagen no disponible" class="card-img-top img-fluid">
        <div class="card-body">
            ...
            <div class="opciones">
                ...
                <input type="checkbox" id="deleteCheck" class = "d-none">
            </div>
        </div>
    </div>';
    }
